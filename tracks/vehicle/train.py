"""
Cargo Payload Track Gï¿½ï¿½ Model Training Script

Algorithm comparison:
  Gï¿½ï¿½ RandomForestRegressor  (sklearn)
  Gï¿½ï¿½ XGBRegressor           (xgboost)
...
def train_and_log(model, model_name: str, X_train, X_test, y_train, y_test) -> tuple:
    with mlflow.start_run(run_name=model_name) as run:
        ...
        print(f"[{model_name}]  MAE={mae:.3f}  RMSE={rmse:.3f}  R-ï¿½={r2:.3f}")
